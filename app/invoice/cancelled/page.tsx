  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="bg-white rounded-3xl shadow-xl p-10 w-full max-w-md text-center">
        ...
        <Link href="/" className="inline-block text-white font-bold px-8 py-3 rounded-xl w-full mb-3" style={{ background: '#185FA5' }}>
          Return to Homepage
        </Link>
        ...
        <p className="mt-4 text-xs text-gray-400">Need help? Email us at <a href="mailto:office@thegasologist.com" className="underline">office@thegasologist.com</a></p>
      </div>
    </div>
  )
}

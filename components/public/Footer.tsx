...
export default function Footer() {
  return (
    <footer style={{ background: '#1f2a2e' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Image src="/logo.png" alt="L. Price Building Company" width={44} height={44} className="object-contain" />
              <span className="text-white font-bold text-lg" style={{ color: '#c9a870' }}>L. Price Building Co.</span>
            </div>
            <p className="text-sm leading-relaxed mb-4" style={{ color: 'rgba(255,255,255,0.6)' }}>
              Custom home design, building &amp; remodeling. Your vision, pieced together with thought and care.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Custom Home Building','Home Remodeling','Kitchen & Bath Design','Residential Construction','Consultation','Project Management'].map(s => (
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href="tel:+18505989128" className="flex items-center gap-3 text-sm transition-colors hover:text-white" style={{ color: 'rgba(255,255,255,0.6)' }}>
                <Phone size={15} /> 850-598-9128
              </a>
              <a href="mailto:Lacey@LaceyNPrice.com" className="flex items-center gap-3 text-sm transition-colors hover:text-white" style={{ color: 'rgba(255,255,255,0.6)' }}>
                <Mail size={15} /> Lacey@LaceyNPrice.com
              </a>
            </div>
            <div className="mt-6">
              <a href="#schedule" className="inline-block text-white font-bold px-6 py-2.5 rounded-full text-sm transition-all"
                style={{ background: '#b8895a' }}>Book a Consultation</a>
            </div>
          </div>
        </div>
        <div className="border-t mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4" style={{ borderColor: 'rgba(255,255,255,0.1)' }}>
          <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>&copy; {new Date().getFullYear()} L. Price Building Company. All rights reserved. Lic# RR282812182</p>
